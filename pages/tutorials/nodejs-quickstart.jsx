          ...
          <main style={{ flex: 1, minWidth: 0 }}>
            ...
            <div style={{ marginBottom: 40 }}>
              <div style={{ display: 'flex', gap: 10, marginBottom: 16 }}>
                ...
                <span style={{ fontSize: 11, fontWeight: 700, color: 'rgba(255,255,255,0.72)', background: 'rgba(255,255,255,0.05)', padding: '3px 9px', borderRadius: 5, letterSpacing: '0.04em' }}>Node.js</span>
                <span style={{ fontSize: 11, fontWeight: 700, color: 'rgba(255,255,255,0.72)', background: 'rgba(255,255,255,0.05)', padding: '3px 9px', borderRadius: 5, letterSpacing: '0.04em' }}>TypeScript</span>
              </div>
