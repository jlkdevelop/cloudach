  ...
  return (
    <>
      ...
      <main style={{ maxWidth: 720, margin: '0 auto', padding: '88px 48px' }}>
        ...
        <h1 style={{ fontSize: 42, fontWeight: 700, letterSpacing: -1.5, lineHeight: 1.12, color: '#0D0F1A', margin: '16px 0 8px' }}>Acceptable Use Policy</h1>
        <p style={{ fontSize: 13, color: '#9CA3AF', marginBottom: 16 }}>Last updated: April 14, 2026</p>
        <div style={{ display: 'flex', gap: 16, marginBottom: 40, flexWrap: 'wrap' }}>
          <Link href="/terms" style={{ fontSize: 13, color: '#6366F1' }}>Terms of Service</Link>
